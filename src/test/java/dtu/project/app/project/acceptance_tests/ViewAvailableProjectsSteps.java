...
public class ViewAvailableProjectsSteps {
    ...
    public void projectsWithTheseNamesAreContainedInTheDatabase(io.cucumber.datatable.DataTable dataTable) {
        // Write code here that turns the phrase above into concrete actions
    ...
    public void theUserLooksAtAvailableProjects() {
        // Write code here that turns the phrase above into concrete actions
        throw new io.cucumber.java.PendingException();
    }
    @Then("“New roofing for {int}” and “Blinds in all buildings” are shown")
    public void newRoofingForAndBlindsInAllBuildingsAreShown(Integer int1) {
        // Write code here that turns the phrase above into concrete actions
        throw new io.cucumber.java.PendingException();
    }
    ...
    public void theUserTriesToAccessAvailableProjects() {
        // Write code here that turns the phrase above into concrete actions
        throw new io.cucumber.java.PendingException();
    }
    ...
    @Given("the user is viewing available projects")
    public void theUserIsViewingAvailableProjects() {
        // Write code here that turns the phrase above into concrete actions
        throw new io.cucumber.java.PendingException();
    }
